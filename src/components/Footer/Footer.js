                ...
                <div className="container-fluid">
                    <div className="row">
                        ...
                        <div className="col-md-4 col-sm-6">
                            ...
                            <ul className="list-unstyled">
                                <li><a href="https://tetra-devs.github.io">Find us on web</a></li>
                        ...
                        <div className="col-md-3 col-sm-6">
                            <h4>Find Us</h4>
                            <ul className="list-unstyled">
                                <li><a href="https://github.com/tetra-devs"> <img src={github} alt="github" className="icons" />  Github</a></li>
                    ...
                    <div className="footer-bottom">
                        <p className="text-xs-center">
                            &copy; {new Date().getFullYear()} <img height={50} src={mainlogo} alt="logo" /> Tetra Devs Community - All Rights Reserved
                        </p>
                    </div>
                </div>
            </div>
